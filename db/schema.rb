...
ActiveRecord::Schema.define(version: 20150730175628) do
  ...
  add_index "matches", ["winner_id", "loser_id"], name: "index_matches_on_winner_id_and_loser_id", unique: true, using: :btree
